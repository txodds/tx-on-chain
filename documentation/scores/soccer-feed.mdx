...
<Card
  title="Free Tier Coverage"
  icon="trophy"
  href="/documentation/subscription-tiers"
>
  Get free access to MLS, World Cup & International Friendlies data with TxLINE's complimentary tiers. Real-time and 60-second delayed options available.
</Card>
