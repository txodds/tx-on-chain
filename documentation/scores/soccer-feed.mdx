...
For a complete list of upcoming soccer fixtures and competitions covered by TxLINE, please refer to the [Match Schedule](/scores/schedule).
...
<Card
  title="Download"
  icon="file-pdf"
  href="https://txodds.github.io/tx-on-chain/assets/txodds-soccer-feed-v1.0.pdf"
>
