...
Basketball score encodings and feed semantics are documented below. The shared [Schedule](/documentation/scores/schedule) currently lists confirmed soccer fixtures; use the fixtures snapshot API for current basketball fixture availability.
