...
The TxLINE scores feed delivers granular sports score data that can be validated against on-chain Merkle roots. Current documentation covers soccer, US football, and basketball score encodings, with MLS, World Cup and International Friendlies coverage available through the free tiers where enabled.
...
| Feed | What to use |
|------|-------------|
| Soccer | [Soccer Feed](/documentation/scores/soccer-feed) for soccer stat keys and game phases |
