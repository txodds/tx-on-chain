---
title: "Schedule"
description: "Confirmed soccer fixtures currently listed for TxLINE coverage"
---
...
<Note>
`Home Team` and `Away Team` are feed designations derived from the fixture's participant mapping. Neutral-site matches can still have a designated home side; this does not mean the match is played in that team's country.
</Note>

<Info>
**Coverage Details**: The listed soccer fixtures are confirmed for TxLINE coverage with data feeds and on-chain verification. Use the fixtures snapshot API for current fixture availability in other sports.
</Info>
