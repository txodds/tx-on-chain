...
<Note>
Devnet currently documents service level `1` for the free World Cup and International Friendlies tier. Use mainnet for service level `12` unless the devnet pricing matrix you fetch on-chain includes row `12`.
</Note>
