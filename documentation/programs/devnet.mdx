---
title: "IDL & Types (Devnet)"
description: "Interface Definition Language and TypeScript types for TxLINE programs"
---
...
These snippets mirror the current devnet example files in `examples/devnet/idl/txoracle.json` and `examples/devnet/types/txoracle.ts`.
