...
async function main() {
  console.log("Starting trading streaming example");
  ...
  console.log("Starting trading stream...");
  ...
  console.log("Receiving trading updates...");
  try {
      ...
      for (const line of lines) {
        if (line.startsWith("data: ")) {
          try {
            ...
            eventCount++;
            console.log(`Trading Update ${eventCount}:`, data);
