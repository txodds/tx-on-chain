...
// Each returned V2 leaf is covered exactly once by an exact-value predicate.
...
async function main(): Promise<void> {
  ...
  const name = "V2 four-stat example";
...
main().then(
  ...
  error => {
    ...
    console.error(error instanceof Error ? error.message : "Four-stat V2 example failed");
    process.exit(1);
  },
);
